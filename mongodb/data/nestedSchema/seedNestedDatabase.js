...
const generateRestaurant = require('./generateNestedData.js');
...
const database = process.env.DATABASE || 'business_info_mongo_nested';
...
const indexDb = async (collection) => {
  await collection.createIndex({ 'result.place_id': 1 }, { unique: true });
};
